...
namespace LiteNetLib
{
    ...
    public interface INetEventListener
    {
        ...
        void OnNetworkReceive(NetPeer peer, NetPacketReader reader, DeliveryMethod deliveryMethod, byte deliveryChannel);
    ...
    public class EventBasedNetListener : INetEventListener, IDeliveryEventListener
    {
        ...
        public delegate void OnNetworkReceive(NetPeer peer, NetPacketReader reader, DeliveryMethod deliveryMethod, byte deliveryChannel);
        ...
        void INetEventListener.OnNetworkReceive(NetPeer peer, NetPacketReader reader, DeliveryMethod deliveryMethod, byte deliveryChannel)
        {
            if (NetworkReceiveEvent != null)
                NetworkReceiveEvent(peer, reader, deliveryMethod, deliveryChannel);
        }
