...
namespace LiteNetLib
{
    ...
    public class NetManager : INetSocketListener, IEnumerable<NetPeer>
    {
            ...
            object userData = null)
        {
            ...
            evt.channelID = readerSource == null ? (byte)0 : readerSource.ChannelId;
        ...
        private void ProcessEvent(NetEvent evt)
        {
            ...
            switch (evt.Type)
            {
                ...
                case NetEvent.EType.Receive:
                    _netEventListener.OnNetworkReceive(evt.Peer, evt.DataReader, evt.DeliveryMethod, (byte)(evt.channelID / 4));
                    break;
        ...
        internal void CreateReceiveEvent(NetPacket packet, DeliveryMethod method, int headerSize, NetPeer fromPeer)
        {
            ...
            evt.channelID = packet.ChannelId;
